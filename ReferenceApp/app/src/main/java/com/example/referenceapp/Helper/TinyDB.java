...
public class TinyDB {
    ...
    public ArrayList<Documents> getListObject(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<Documents> playerList =  new ArrayList<Documents>();

        for(String jObjString : objStrings){
            Documents player  = gson.fromJson(jObjString,  Documents.class);
    ...
    public void putListObject(String key, ArrayList<Documents> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(Documents player: playerList){
